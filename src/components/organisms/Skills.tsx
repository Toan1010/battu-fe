    ...
    <section id="skills" className="py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Backend Skills Box */}
          <div className="p-8 rounded-2xl bg-white dark:bg-white/5 border border-slate-205 dark:border-slate-800/80 hover:border-violet-500/30 hover:shadow-lg dark:hover:shadow-none transition-all duration-300 text-left">
            <div className="flex items-center gap-3 mb-6">
          ...
          <div className="p-8 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-slate-800/80 hover:border-blue-500/30 hover:shadow-lg dark:hover:shadow-none transition-all duration-300 text-left">
            ...
            <div className="flex flex-wrap gap-2.5">
              {['PostgreSQL', 'MongoDB', 'MySQL', 'Redis', 'Docker', 'Git / GitHub', 'CI/CD (GitHub Actions)', 'Vercel / Netlify'].map((skill, index) => (
                <span key={index} className="px-3.5 py-1.5 text-sm font-semibold rounded-xl bg-blue-50 dark:bg-blue-500/5 text-blue-600 dark:text-blue-300 border border-blue-100 dark:border-blue-500/20 hover:bg-blue-100 dark:hover:bg-blue-500/10 hover:border-blue-300 dark:hover:bg-blue-500/40 transition-colors">
                  {skill}
                </span>
              ))}
            </div>
